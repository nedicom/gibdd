	...
	<div class="toast show">
		<div class="toast-header">
			<div class="d-inline-flex justify-content-between w-100">
				...
				<div class="d-flex align-items-center">
					<a role="button" type="button" class="btn text-start w-100" data-bs-toggle="collapse" id="collapsebut" data-bs-target="#collapsetest" aria-expanded="false" aria-controls="collapsetest">Чат с юристом<i class="btn bi bi-list"></i> </a>
				</div>
		...
		<div class="toast-body collapse m-1" id="collapsetest" style="background-image: url('src/message/img/whatsapp.jpg'); background-repeat: no-repeat, repeat; background-size: cover;">
